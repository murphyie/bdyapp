        ...
        {photos.map((photo, index) => (
          ...
          >
            <div className="overflow-hidden rounded-xl glass-card">
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-background/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl">
